...
\begin{enumerate}
    ...
    \item \textbf{Panel del Administrador (Acceso Aislado):} Escriba la ruta manual \url{http://localhost/admin} en la barra de direcciones de su navegador. Ingrese el usuario configurado en \texttt{VITE\_ADMIN\_USER} y la API Key definida en \texttt{ADMIN\_API\_KEY} para acceder al panel de administración. No se distribuyen credenciales por defecto.
\end{enumerate}
