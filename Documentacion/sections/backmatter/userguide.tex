...
\begin{enumerate}
    ...
    \item \textbf{Buscador de Titulaciones y BOE:} En la pestaña "Titulaciones", busque por cualquier titulación o filtre por Grado, Máster o Doctorado. Al abrir una tarjeta se muestra la estructura curricular disponible y, cuando se haya verificado, el enlace a la fuente oficial. Algunos documentos oficiales sólo publican un resumen de créditos; en esos casos el portal no inventa asignaturas ausentes.
