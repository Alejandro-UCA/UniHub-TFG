...
\begin{enumerate}
    ...
    \item \textbf{Capa de Ingesta (Crawler):} Módulo independiente en Python estructurado en 2 procesos paralelos y 2 partes (RUCT/BOE y webs oficiales de universidades) con servicio Cron para ejecuciones desatendidas mensuales (Fase 1).
\end{enumerate}
