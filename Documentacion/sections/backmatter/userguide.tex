...
\begin{enumerate}
    ...
    \item \textbf{Panel del Administrador (Acceso Aislado):} Escriba la ruta manual \url{http://localhost/admin} en la barra de direcciones de su navegador. Ingrese el usuario \texttt{admin} y la contraseña \texttt{admin\_pass\_2026} para acceder al panel de salud física de contenedores, métricas en vivo del crawler y gestión CRUD de universidades y titulaciones.
\end{enumerate}
