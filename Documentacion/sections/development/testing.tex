...
\end{lstlisting}
El resultado de la verificación es de \textbf{346 pruebas superadas} y \textbf{una prueba omitida} de forma explícita (evaluación empírica con descarga de red en vivo), completándose la ejecución íntegra en apenas \textbf{21.8 segundos}.
