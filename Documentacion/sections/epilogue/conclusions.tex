...
\begin{itemize}
    ...
    \item \textbf{Calidad curricular:} Un plan se clasifica según la fuente disponible, la presencia de elementos curriculares y la coherencia de sus créditos. Un documento BOE que sólo contiene un resumen de ECTS no se contabiliza como un plan detallado.
    ...
    \item \textbf{Rendimiento y sostenibilidad:} Las métricas de tiempo, caché, memoria y huella estimada se registran por ejecución. Deben comunicarse como observaciones reproducibles, no como calificaciones absolutas del algoritmo.
\end{itemize}
