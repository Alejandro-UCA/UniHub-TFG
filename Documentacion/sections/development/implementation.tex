...
\begin{itemize}
    ...
    \item \textbf{Librerías y Herramientas JavaScript:} React 18, Vite 8, Oxlint, Lucide React (iconografía UCA), \texttt{usageTracker} analytics, \texttt{perfTracker} performance telemetry.
...
\begin{itemize}
    ...
    \item Dispone del catálogo oficial pre-cargado \texttt{OFFICIAL\_SIIU\_PRICES\_CATALOG} para las 17 Comunidades Autónomas más la UNED, garantizando precios exactos incluso en ausencia de conexión a los portales regionales.
...
\begin{figure}[htbp]
    ...
    \caption{Algoritmo de cómputo tarifario oficial SIIU, cacheo en memoria RAM y sincronización atómica de la Fase 1 Parte 3}
