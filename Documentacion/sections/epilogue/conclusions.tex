...
\begin1
    \item Construcción de un rastreador modular en Python (Fase 1) capaz de procesar el catálogo oficial, clasificar Doctorados (RD 99/2011), aplicar filtro estricto de vigencia (descarte de extinguidas), deduplicar por Real Decreto, escanear todos los PDFs candidatos del BOE, aplicar resiliencia de conexión (5m/15m cortocircuito), medir rendimiento y notificar automáticamente a la API REST.
