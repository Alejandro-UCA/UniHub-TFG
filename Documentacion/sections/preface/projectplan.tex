...
\begin{itemize}
    \item \textbf{Fase 1 (Crawler):} Python 3.12, \texttt{xlrd} (lectura de XLS BIFF8), \texttt{BeautifulSoup4} (HTML parsing), \texttt{pdfplumber} y \texttt{pypdf} (extracción de tablas PDF de BOE), \texttt{psutil} (medición de memoria/CPU) y Cron para ejecución mensual programada.
    ...
    \item \textbf{Fase 3 (Web):} Node.js 20, Vite, React 18 (JSX), Vanilla CSS (Tokens UCA), Lucide Icons, Geolocation API y analítica local \texttt{usageTracker}.
