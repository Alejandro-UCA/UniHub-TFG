...
\begin{tabularx}{\textwidth}{p{3.8cm} c c c c c}
\toprule
\textbf{Funcionalidad / Característica} & \textbf{RUCT} & \textbf{BOE} & \textbf{QEDU} & \textbf{Portales Univ.} & \textbf{UniHub} \\
\midrule
Catálogo global (Públicas y Privadas) & Sí & No (disperso) & Sí & No (local) & \textbf{Sí} \\
Desglose curricular de asignaturas (BOE) & No & Sí (PDF plano) & No & Sí (heterogéneo) & \textbf{Sí (estructurado)} \\
Detección de Menciones oficiales & No & No & No & Parcial & \textbf{Sí (verificado)} \\
Tratamiento diferenciado de Doctorados & Parcial & Parcial & No & Parcial & \textbf{Sí (RD 99/2011)} \\
...
API REST documentada y pública & No & Parcial & No & Raras excepciones & \textbf{Sí (FastAPI/Swagger)} \\
Arquitectura contenerizada (Docker) & No pública & No pública & No pública & Propietaria & \textbf{Sí (Docker Compose)} \\
\bottomrule
\end{tabularx}
\end{table}
