...
\begin1
    ...
    \item Clonar o abrir la carpeta raíz del repositorio \texttt{d:\textbackslash Proyecto}.
...
\begin{itemize}
    ...
    \item \textbf{Ejecutar Carga ETL:} \texttt{docker compose exec api python database/etl_loader.py}.
\end{itemize}
