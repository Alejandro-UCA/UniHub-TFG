En este capítulo se presentan los objetivos y el catálogo de requisitos del sistema \textbf{UniHub}. Opcionalmente, se incluye el análisis de la brecha entre los requisitos planteados y la solución base seleccionada.
